 ...
 */
	...
	public function getTablettes(){
	    $req = "select tablette.numtablette as numtablette, tablette.typeT as typeT, tablette.capaciteI as capaciteI, tablette.capaciteE as 		    capaciteE from tablette";
            $stmp = PdoGsb::$monPdo->prepare($req);
	    $stmp->execute();
	    $lesLignes=$stmt->fetchAll();
	    return $lesLignes;
	}
